...
public class PantallaInstrucciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("¿Cómo Funciona el Juego \"De la A a la Z\"?");

        jLabel2.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel2.setText("\"De la A a la Z\" es un juego de palabras donde el objetivo es ser el  ");

        jLabel5.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel5.setText("último jugador en pie. Cada jugador debe ingresar una  palabra que");

        jLabel4.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel4.setText("comience con la letra indicada antes de que se  agote el tiempo,  que ");

        jLabel6.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel6.setText("puede configurarse entre 5 y 25 segundos.");

        jLabel7.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel7.setText("Si no se configura, el tiempo por ronda es de 15 segundos y el  orden");

        jLabel8.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel8.setText("es por defecto. Si fallas, serás eliminado. El último jugador  que acierte ");

        jLabel9.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel9.setText("una palabra gana el juego.");

        jLabel10.setFont(new java.awt.Font("Serif", 1, 20)); // NOI18N
        jLabel10.setText("¡Diviértete mejorando tu vocabulario y rapidez mental con \"De la A a la Z\"!");
